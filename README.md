...
Create a directory, named localhost in which you will put different files and directories to configure the website.<br/>

**line 7 :** `cp nginx/nginx.conf /etc/nginx/sites-available/localhost` <br/>
Copies your nginx.conf in the sites-available directory and rename it as localhost (or the name you chose earlier). Before we go further, let's have a look
